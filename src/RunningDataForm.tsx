...
export default function RunningData(props: RunningDataProps): JSX.Element {
    ...
    return (
        <form className="form-data" onSubmit={handleSubmitButton}>
            <label>
                Hours:
                <input name="hours" type="number" value={runningData.hours} onChange={handleRunningData}/>
            </label>
            <label>
                Minutes:
                <input name="minutes" type="number" value={runningData.minutes} onChange={handleRunningData}/>
            </label>
            <label>
                Seconds:
                <input name="seconds" type="number" value={runningData.seconds} onChange={handleRunningData}/>
            </label>
            <label>
                Distance(km):
                <input name="distance" type="number" value={runningData.distance} onChange={handleRunningData}/>
            </label>
